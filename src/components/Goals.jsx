...
const goalsData = [
  {
    title: "1. Infraestructura sostenible",
    description:
  ...
  {
    title: "2. Industrialización sostenible",
    description:
  ...
  {
    title: "4. Modernizar Infraestructura",
    description:
  ...
  {
    title: "5. Aumentar investigación",
    description:
      "Aumentar la investigación científica y mejorar la capacidad tecnológica de los sectores industriales de todos los países, en particular los países en desarrollo, entre otras cosas fomentando la innovación y aumentando el número de personas que trabajan en investigación y desarrollo por cada millón de habitantes y aumentando considerablemente los gastos en investigación y desarrollo del sector privado y la administración pública.",
    img: img5,
  },
];
